...
const Model = ({ open, posts, loading }) => {
  ...
  const SubmitForm = async () => {
    loading(true)
    await axios
      .post(process.env.NEXT_PUBLIC_HOST, {
      ...
      <div className="w-96 -mt-44  h-auto bg-white rounded p-5">
        <div className="flex items-center  justify-center">
          ...
          <input
            ...
            className="w-4/5 h-8 rounded outline-none ml-2 bg-gray-300"
        ...
        <div className="p-5 flex cursor-pointer items-center">
          ...
          <p className="ml-4" onClick={handleVideo}>
            Add Video
          </p>
        </div>
        {openImg && (
        ...
        {openVideo && (
          <div className="p-5">
            ...
            <input
              onChange={Video}
              value={video}
              className="w-4/5 h-8 rounded outline-none bg-gray-300"
        ...
        <button
          ...
          className="w-4/5 outline-none border-0 ml-10 mb-2 hover:opacity-80 h-8 bg-green-500"
        >
          Submit Post
        </button>
        <button
